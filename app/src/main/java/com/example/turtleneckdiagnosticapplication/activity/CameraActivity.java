...
import com.example.turtleneckdiagnosticapplication.fragment.Camera2BasicFragment;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            File mFile = new File(getExternalFilesDir(null), "posture.jpg");
            ...
            intent.putExtra("posturePath", mFile.toString());
