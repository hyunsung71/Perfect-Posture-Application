...
import com.example.turtleneckdiagnosticapplication.view.AutoFitTextureView;
    ...
    */
    ...
    private static class ImageUploader implements Runnable {
        ...
        public void run() {
            ...
            final StorageReference mountainImagesRef = storageRef.child("users/"+user.getUid()+"/posture.jpg");
